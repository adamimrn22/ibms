...
$(document).ready(function () {
    ...
    $(document).on('click', '#Pagination a', function (e) {
        ...
        let searchTerm = $('#searchExtensionCord').val();
    ...
    $(document).on('keyup', '#searchExtensionCord', function () {
    ...
    function fetch_data(page, searchTerm = '', status = '', recordsPerPage = '') {
        $.ajax({
            ...ajaxSettings,
            url: `${baseUrl}/UIT/Inventory/Hardware/Extension-cord`,
            type: "GET",
            data: {
                page: page,
                search: searchTerm,
            ...
            success: function (data) {
                spinnerContainer.hide();
                $('#extensionCordTable').html(data.table).show();
