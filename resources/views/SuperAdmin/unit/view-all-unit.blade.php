                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List of all unit</h4>
                            </div>
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-baseline">
                                    <p class="card-text">
                                        Here is the list of all unit </p>
                            ...
                            <div class="d-flex justify-content-between align-items-center mx-0 mb-2 row">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="input-group">
                                        <input type="text" id="searchUnit" placeholder="Search unit..."
                                            class="form-control">
                                    </div>
                                </div>
...
@section('script')
    <script src="{{ asset('js/SuperAdmin/unit/viewAllUnitTable.js') }}"></script>
    <script src="{{ asset('js/SuperAdmin/unit/addUnit.js') }}"></script>
    <script src="{{ asset('js/SuperAdmin/unit/editUnit.js') }}"></script>
    <script src="{{ asset('js/SuperAdmin/unit/deleteUnit.js') }}"></script>
@endsection
