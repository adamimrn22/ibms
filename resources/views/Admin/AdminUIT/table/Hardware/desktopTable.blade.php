<div id="desktopTable">
    <table class="table">
        ...
        <tbody>
            @forelse ($data as $index => $desktop)
                <tr>
                    <td>
                        {{ $data->firstItem() + $index }}
                    </td>
                    <td>
                        <a href="{{ route('uit.Desktop.show', ['Desktop' => Crypt::encryptString($desktop->id)]) }}">
                            {{ strtoupper($desktop->name) }}
                        </a>
                    </td>
                    <td>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item"
                                    href="{{ route('uit.Desktop.edit', ['Desktop' => Crypt::encryptString($desktop->id)]) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <a class="dropdown-item delete-desktop-modal" href="javascript:void(0);"
                                    data-bs-target="#deleteDesktopModal" data-bs-toggle="modal"
