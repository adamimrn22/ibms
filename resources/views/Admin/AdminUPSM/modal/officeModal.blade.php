        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Add Ruang Pejabat</h1>
                </div>
                ...
                <form id="addRuangKelasForm" class="row gy-1 pt-75" onsubmit="return false" novalidate="novalidate">
                    ...
                    <div class="col-12 col-md-6">
                        <label class="form-label" for="classDuster">Desktop</label>
                        <input type="number" id="classDuster" name="classDuster" class="form-control" placeholder="1">
                    </div>

                    <div class="col-12 col-md-6">
                        <label class="form-label" for="classDuster">Drawer</label>
                        <input type="number" id="classDuster" name="classDuster" class="form-control" placeholder="1">
                    </div>

                    <div class="col-12 col-md-6">
                        <label class="form-label" for="classDuster">Sofa</label>
                        <input type="number" id="classDuster" name="classDuster" class="form-control" placeholder="1">
                    </div>
